...
def analyze_uploaded_image(image_path: str):
    ...
    if verdict_key == "likely_ai_generated":
        ...
        verdict_icon = "?"
        verdict_subtitle = "The available evidence is not strong enough for a reliable conclusion."
    ...
    if (
    ...
    elif verdict_key == "likely_ai_generated":
        ...
        source_html = """
        <div class="metric-card">
            <div class="metric-label">GENERATOR ATTRIBUTION</div>
            <div class="metric-value muted">Not applicable</div>
            <div class="metric-detail">
                Generator attribution is only relevant to likely AI-generated images.
            </div>
        </div>
        """
